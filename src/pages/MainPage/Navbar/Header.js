...
const Header = () => {
  return (
    <div className="max-w-[90rem] mx-auto sticky left-0 top-0 z-50">
      <div className=" border-b-[1px] border-gray-200 h-fit bg-white p-3">
        <div className="flex items-center justify-between">
          <div className="h-12 w-48 object-fill flex items-center justify-center">
            <Link to="/">
              <img
                src={require("../../../Screenshot 2022-10-26 160611.jpg")}
                alt="jatic-logo"
              />
            </Link>
          </div>
          ...
          <div className="flex items-center justify-around ">
            <div className="flex items-center justify-center gap-2 cursor-pointer px-5 border-l-[1.5px] border-gray-300">
              <svg
            ...
            <div className="flex items-center justify-around w-fit px-3 mr-2 bg-gray-50 h-16 rounded-2xl">
              <div className="flex items-center justify-center gap-1 ">
                ...
                <span className="text-[0.75rem] font-semibold text-gray-600">
                  اعلانات شما
                </span>
                <span className="flex items-center justify-center bg-[#00a3a6] shadow-lg rounded-xl w-[2.3rem] h-[2.3rem] mr-1 text-white font-semibold ">
                  2
                </span>
              </div>
            </div>
